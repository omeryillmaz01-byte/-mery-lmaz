...
# Load AKBANK file
print("Reading AKBANK account movements...")
wb_akbank = load_workbook('/root/.claude/uploads/d3c97f87-f4b1-50a0-88f9-174947e8589b/c9e2c686-HesapHareketleri_17.08.2026_0183316.xlsx')
ws = wb_akbank.active

# Extract KS: rows
daily_totals = {}
pattern = r'KS:[\s]*([0-9]+[.,][0-9]+)'
