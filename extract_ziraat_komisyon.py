...
# Load ZIRAAT file
print("Reading ZIRAAT BANKASI commission data...")
wb_ziraat = load_workbook('/root/.claude/uploads/d3c97f87-f4b1-50a0-88f9-174947e8589b/561bce11-___k_petrol.xlsx')
ws = wb_ziraat.active
...
# Save workbook
wb.save('/home/user/-mery-lmaz/ZİRAAT-KOMİSYON-Temmuz2026.xlsx')
