...
# Load AKBANK file
print("Reading AKBANK account movements (2nd account)...")
wb_akbank = load_workbook('/root/.claude/uploads/d3c97f87-f4b1-50a0-88f9-174947e8589b/29f940e5-HesapHareketleri_17.08.2026_0028620.xlsx')
ws = wb_akbank.active
...
for row in ws.iter_rows(min_row=2, values_only=False):
    ...
    if tarih_cell.value and aciklama_cell.value:
        tarih = str(tarih_cell.value).strip()
...
# Save workbook
wb.save('/home/user/-mery-lmaz/AKBANK-KS_Satirlari-2-Temmuz2026.xlsx')
